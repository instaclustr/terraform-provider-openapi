...
func (s *SpecSchemaDefinitionProperty) shouldIgnoreOrderSet() bool {
...
func (s *SpecSchemaDefinitionProperty) shouldIgnoreSetItemsOrder() bool {
	return s.isSetProperty() && s.IgnoreItemsOrder
}
